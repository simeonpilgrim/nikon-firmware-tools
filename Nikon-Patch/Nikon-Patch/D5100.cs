...
namespace Nikon_Patch
{
    ...
    class D5100_0102 : Firmware
    {
        ...
        Patch[] HDMI_full_sized_1080_central_crop = {
            //manual 'manual new Patch(0, 0x03739A, new byte[] { 0xA0, 0x62 } , new byte[] { 0x6B, 0xFF } ),
            //patch_battery new Patch(0, 0x08B52A, new byte[] { 0xF0, 0x28, 0xA2, 0x52, 0xF0, 0x60 } , new byte[] { 0x6A, 0x20, 0x6A, 0x20, 0x6A, 0x20 } ),
            //patch_battery new Patch(0, 0x08C980, new byte[] { 0xF0, 0x28, 0xA4, 0x92 } , new byte[] { 0x6C, 0x20, 0x6C, 0x20 } ),
            //Jpeg Compression new Patch(1, 0x0C0842, new byte[] { 0x81, 0xB0 } , new byte[] { 0x91, 0x40 } ),
            //Jpeg Compression new Patch(1, 0x0C29C0, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x0C2E82, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x0C5F3A, new byte[] { 0xE3 } , new byte[] { 0xE1 } ),
            //NEF Compression new Patch(1, 0x0D7AEE, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x0D7B74, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x0D7C06, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x0D7E72, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x0D7EF2, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x0D7F86, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x0D7FEC, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            new Patch(1, 0x0D8357, new byte[] { 0x11, 0xAB, 0x6C, 0x97, 0x1C } , new byte[] { 0x24, 0xC4, 0x00, 0x97, 0x0C } ),
            //NEF Compression new Patch(1, 0x0D8D48, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x0D8DCA, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //patch_clean_hdmi new Patch(1, 0x0DC53E, new byte[] { 0xE2 } , new byte[] { 0xE1 } ),
            //NEF Compression new Patch(1, 0x115408, new byte[] { 0xE2 } , new byte[] { 0xE1 } ),
            //NEF Compression new Patch(1, 0x115560, new byte[] { 0xE2 } , new byte[] { 0xE1 } ),
            //NEF Compression new Patch(1, 0x1159C6, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x115C2A, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x115C8C, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x1172B8, new byte[] { 0xE3 } , new byte[] { 0xE1 } ),
            //NEF Compression new Patch(1, 0x13DC5E, new byte[] { 0xE2 } , new byte[] { 0xE1 } ),
            //NEF Compression new Patch(1, 0x144018, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x1466B8, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //NEF Compression new Patch(1, 0x154A04, new byte[] { 0xF2 } , new byte[] { 0xF0 } ),
            //HDMI_output_1080i new Patch(1, 0x17E467, new byte[] { 0x14 } , new byte[] { 0x04 } ),
            //NEF Compression new Patch(1, 0x1A617C, new byte[] { 0xF2 } , new byte[] { 0xF1 } ),
            //HDMI_full_sized_1080i
            new Patch(1, 0x2012A8, new byte[] {0x00,0x00,0xD2,0xF6, 0x00,0x20,0x0D,0x7B, 0x00,0x2F,0xDF,0x7B}, new byte[] {0x00,0x00,0x00,0x00, 0x00,0x1F,0xA4,0x00, 0x00,0x2F,0x76,0x00} ),
            new Patch(1, 0x2012B4, Sys.LittleWords(1920,960,1428,950,714,950), Sys.LittleWords(1920,960,1920,1080,960,1080)),

            //HDMI_full_sized_720p
            //new Patch(1, 0x2012C4, new byte[] {0x00,0x00,0x5a,0xa4, 0x00,0x0E,0x3D,0x52, 0x00,0x15,0x45,0x52}, new byte[] {0x00,0x00,0x00,0x00, 0x00,0x0E,0x10,0x00, 0x00,0x15,0x18,0x00} ),
            //new Patch(1, 0x2012D0, Sys.LittleWords(1280,640,952,634,476,634 ), Sys.LittleWords(1280,640,1280,720,640,720 )),
            ...
            //manual liveview new Patch(1, 0x265514, new byte[] { 0x53, 0x57, 0x33, 0x3A, 0x4F, 0x46, 0x46, 0x00, 0x53, 0x57, 0x33, 0x3A, 0x4F, 0x4E, 0x20, 0x00, 0x53, 0x57, 0x32, 0x3A, 0x4F, 0x46, 0x46, 0x00, 0x53, 0x57, 0x32, 0x3A, 0x4F, 0x4E, 0x20, 0x00, 0x53, 0x57, 0x31, 0x3A, 0x4F, 0x46, 0x46, 0x00, 0x53, 0x57, 0x31, 0x3A, 0x4F, 0x4E } , new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } ),
            //NEF Compression new Patch(1, 0x2E3010, new byte[] { 0xE2 } , new byte[] { 0xE0 } ),
            //patch_clean_hdmi new Patch(1, 0x2FC134, new byte[] { 0xE2 } , new byte[] { 0xE1 } ),
                                                    };
