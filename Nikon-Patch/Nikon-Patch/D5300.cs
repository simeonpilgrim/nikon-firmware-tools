namespace Nikon_Patch
{
    ...
    class D5300_0102 : Firmware
    {
        ...
        //the above value divided by 1,000?
        ...
        Patch[] patch_hq_64mbps = {
            ...
            new Patch(1, 0x12B57D8, mbps_24_20bf, mbps_64_60be ),
            new Patch(1, 0x12B57F0, mbps_24_20bf, mbps_64_60be ),
            new Patch(1, 0x12B58B0, mbps_24_20bf, mbps_64_60be ),

            new Patch(1, 0x12B5D50, mbps_24_20c0, mbps_64_60c0 ),
            new Patch(1, 0x12B5D60, mbps_24_20c0, mbps_64_60c0 ),
            
            new Patch(1, 0x12B5D70, mbps_24_20c1, mbps_64_60c0 ),
            new Patch(1, 0x12B5D80, mbps_24_20c1, mbps_64_60c0 ),
            new Patch(1, 0x12B5D90, mbps_24_20c1, mbps_64_60c0 ),
            new Patch(1, 0x12B5DA0, mbps_24_20c1, mbps_64_60c0 ),
            new Patch(1, 0x12B5DB0, mbps_24_20c1, mbps_64_60c0 ),
            };
