namespace Nikon_Patch
{
    class D610_0101 : Firmware
    {
        Patch[] patch_1080_36mbps_NQ = {
            ...
            // 1080 2 30 fps
            new Patch(1, 0x23DFE, Sys.mbps24 , Sys.mbps40 ),
            new Patch(1, 0x23E04, Sys.mbps20 , Sys.mbps36 ),
            ...
            // 720 0 24 fps
            new Patch(1, 0x23EB0, Sys.mbps10, Sys.mbps40 ),
            new Patch(1, 0x23EB6, Sys.mbps8 , Sys.mbps36 ),
            ...
            // 720 2 30 fps
            new Patch(1, 0x23F08, Sys.mbps12, Sys.mbps40 ),
            new Patch(1, 0x23F0E, Sys.mbps10, Sys.mbps36 ),
            new Patch(1, 0x23F1C, Sys.mbps8 , Sys.mbps24 ),
            new Patch(1, 0x23F22, Sys.mbps6 , Sys.mbps20 ),

            // 720 5 50 fps
            new Patch(1, 0x23F54, Sys.mbps24 , Sys.mbps40 ),
            new Patch(1, 0x23F5A, Sys.mbps20 , Sys.mbps36 ),
        ...
        Patch[] patch_1080_54mbps_NQ = {
            ...
            // 1080 2 30 fps
            new Patch(1, 0x23DFE, Sys.mbps24 , Sys.mbps57 ),
            new Patch(1, 0x23E04, Sys.mbps20 , Sys.mbps53 ),
            new Patch(1, 0x23E12, Sys.mbps12 , Sys.mbps24 ),
            new Patch(1, 0x23E18, Sys.mbps10 , Sys.mbps20 ),
            ...
            // 720 0 24 fps
            new Patch(1, 0x23EB0, Sys.mbps10, Sys.mbps57 ),
            new Patch(1, 0x23EB6, Sys.mbps8 , Sys.mbps53 ),
            new Patch(1, 0x23EC4, Sys.mbps6 , Sys.mbps24 ),
            new Patch(1, 0x23ECA, Sys.mbps5 , Sys.mbps20 ),
            ...
            // 720 2 30 fps
            new Patch(1, 0x23F08, Sys.mbps12, Sys.mbps57 ),
            new Patch(1, 0x23F0E, Sys.mbps10, Sys.mbps53 ),
            new Patch(1, 0x23F1C, Sys.mbps8 , Sys.mbps24 ),
            new Patch(1, 0x23F22, Sys.mbps6 , Sys.mbps20 ),

            // 720 5 50 fps
            new Patch(1, 0x23F54, Sys.mbps24 , Sys.mbps57 ),
            new Patch(1, 0x23F5A, Sys.mbps20 , Sys.mbps53 ),
            new Patch(1, 0x23F68, Sys.mbps12 , Sys.mbps24 ),
            new Patch(1, 0x23F6E, Sys.mbps10 , Sys.mbps20 ),
        };
    ...
    class D610_0104 : Firmware
    {
        ...
        public D610_0104()
        {
            ...
            // Added bitrate patches (offsets verified to be identical to v1.01)
