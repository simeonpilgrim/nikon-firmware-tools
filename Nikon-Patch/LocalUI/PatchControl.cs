...
namespace Nikon_Patch
{
    public class PatchControl
    {
        ...
        static PatchControl()
        {
            ...
            hashMap.Add(new byte[] { 0x28, 0xC8, 0xDB, 0x35, 0x83, 0xC1, 0x9A, 0x6A, 0x26, 0xEC, 0x21, 0xB4, 0x7D, 0x6D, 0x4E, 0xC5 }, new D3400_0113());
            ...
            hashMap.Add(new byte[] { 0xDC, 0x79, 0x18, 0x72, 0x35, 0xEE, 0x12, 0xA2, 0x4E, 0x48, 0xE3, 0xB3, 0xFA, 0x3C, 0x4C, 0xA4 }, new D610_0104());
