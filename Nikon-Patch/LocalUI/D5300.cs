    ...
    class D5300_0103 : Firmware
    {
       Patch[] patch_liveview_no_timeout_15m = 
        ...
        Patch[] patch_hq_64mbps = {
            ...
            new Patch(1, 0x12B5DA0-0x30EC0, mbps_24_20be, mbps_64_60be),
            new Patch(1, 0x12B5DB0-0x30EC0, mbps_24_20be, mbps_64_60be),

            //12848A0   -0x30EC0
            new Patch(1, 0x12848A0, mbps_24_20tbe, mbps_64_60tbe),
            new Patch(1, 0x12848B8, mbps_24_20tbe, mbps_64_60tbe),
            new Patch(1, 0x12848D0, mbps_24_20tbe, mbps_64_60tbe),
            new Patch(1, 0x12B57A8-0x30EC0, mbps_24_20tbe, mbps_64_60tbe),
            new Patch(1, 0x12B57C0-0x30EC0, mbps_24_20tbe, mbps_64_60tbe),
            new Patch(1, 0x12B57D8-0x30EC0, mbps_42_35tbe, mbps_64_60tbe),
            new Patch(1, 0x12B57F0-0x30EC0, mbps_42_35tbe, mbps_64_60tbe),
            new Patch(1, 0x12B5808-0x30EC0, mbps_24_20tbe, mbps_64_60tbe),
            new Patch(1, 0x12B5820-0x30EC0, mbps_24_20tbe, mbps_64_60tbe),
            new Patch(1, 0x12B5838-0x30EC0, mbps_24_20tbe, mbps_64_60tbe),
            new Patch(1, 0x12B5850-0x30EC0, mbps_24_20tbe, mbps_64_60tbe),
            new Patch(1, 0x12B5868-0x30EC0, mbps_24_20tbe, mbps_64_60tbe),
            new Patch(1, 0x12B58B0-0x30EC0, mbps_24_20tbe, mbps_64_60tbe),
        };
