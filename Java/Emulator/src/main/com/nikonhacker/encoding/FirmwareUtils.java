...
public class FirmwareUtils {
     ...
     */
    public static int fastComputeChecksum(byte[] buffer, int offset, int length, int initValue, int mask) throws NoSuchAlgorithmException {
...
//        }
    ...
    public static void setUInt16(byte[] buffer, int offset, int value) {
    ...
    public static void setUInt32(byte[] buffer, int offset, int value) {
        for (int i = 0; i < 4; i++) {
