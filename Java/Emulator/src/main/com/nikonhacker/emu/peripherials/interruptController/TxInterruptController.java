...
public class TxInterruptController extends AbstractInterruptController {
    ...
    private static final int INT0 = 2;
    private static final int INT1 = 3;
    private static final int INT2 = 4;
    private static final int INT3 = 5;
    private static final int INT4 = 6;
    private static final int INT5 = 7;
    private static final int INT6 = 8;
    private static final int INT7 = 9;
    private static final int INT8 = 10;
    private static final int INT9 = 11;
    private static final int INTA = 12;
    private static final int INTB = 13;
    private static final int INTC = 14;
    private static final int INTD = 15;
    private static final int INTE = 16;
    private static final int INTF = 17;
    private static final int KWUP = 18;
    private static final int INT10 = 19;
    private static final int INT11 = 20;
    private static final int INT12 = 21;
    private static final int INT13 = 22;
    private static final int INT14 = 23;
    private static final int INT15 = 24;
    private static final int INT16 = 25;
    private static final int INT17 = 26;
    private static final int INT18 = 27;
    private static final int INT19 = 28;
    private static final int INT1A = 29;
    private static final int INT1B = 30;
    private static final int INT1C = 31;
    private static final int INT1D = 32;
    private static final int INT1E = 33;
    private static final int INT1F = 34;
    private static final int INTRX0 = 35;
    private static final int INTTX0 = 36;
    private static final int INTRX1 = 37;
    private static final int INTTX1 = 38;
    private static final int INTRX2 = 39;
    private static final int INTTX2 = 40;
    private static final int HINTRX0 = 41;
    private static final int HINTTX0 = 42;
    private static final int HINTRX1 = 43;
    private static final int HINTTX1 = 44;
    private static final int HINTRX2 = 45;
    private static final int HINTTX2 = 46;
    private static final int INTSBI0 = 47;
    private static final int INTADHPA = 48;
    private static final int INTADMA = 49;
    private static final int INTADHPB = 50;
    private static final int INTADMB = 51;
    private static final int INTADHPC = 52;
    private static final int INTADMC = 53;
    private static final int INTTB0 = 54;
    private static final int INTTB1 = 55;
    private static final int INTTB2 = 56;
    private static final int INTTB3 = 57;
    private static final int INTTB4 = 58;
    private static final int INTTB5 = 59;
    private static final int INTTB6 = 60;
    private static final int INTTB7 = 61;
    private static final int INTTB8 = 62;
    private static final int INTTB9 = 63;
    private static final int INTTBA = 64;
    private static final int INTTBB = 65;
    private static final int INTTBC = 66;
    private static final int INTTBD = 67;
    private static final int INTTBE = 68;
    private static final int INTTBF = 69;
    private static final int INTADA = 70;
    private static final int INTADB = 71;
    private static final int INTADC = 72;
    private static final int INTTB10 = 73;
    private static final int INTTB11 = 74;
    private static final int PHCNT0 = 75;
    private static final int PHCNT1 = 76;
    private static final int PHCNT2 = 77;
    private static final int PHCNT3 = 78;
    private static final int PHCNT4 = 79;
    private static final int PHCNT5 = 80;
    private static final int INTCAP0 = 81;
    private static final int INTCAP1 = 82;
    private static final int INTCAP2 = 83;
    private static final int INTCAP3 = 84;
    private static final int INTCMP0 = 85;
    private static final int INTCMP1 = 86;
    private static final int INTCMP2 = 87;
    private static final int INTCMP3 = 88;
    private static final int INTCMP4 = 89;
    private static final int INTCMP5 = 90;
    private static final int INTCMP6 = 91;
    private static final int INTCMP7 = 92;
    private static final int INTTBT = 93;
    private static final int INTRTC = 94;
    private static final int INTDMA0 = 95;
    private static final int INTDMA1 = 96;
    private static final int INTDMA2 = 97;
    private static final int INTDMA3 = 98;
    private static final int INTDMA4 = 99;
    private static final int INTDMA5 = 100;
    private static final int INTDMA6 = 101;
    private static final int INTDMA7 = 102;
    private static final int SOFT = 103;
    ...
    static {
        ...
        hardwareInterruptDescription[HINTRX1] = new InterruptDescription("HINTRX1", "43 HINTRX1 : High-speed serial reception (Hchannel.1)", TxIoListener.REGISTER_IMC0A, 3, NULL_REGISTER, NULL_SECTION);
        hardwareInterruptDescription[HINTTX1] = new InterruptDescription("HINTTX1", "44 HINTTX1 : High-speed serial transmission (Hchannel.1)", TxIoListener.REGISTER_IMC0B, 0, NULL_REGISTER, NULL_SECTION);
        hardwareInterruptDescription[HINTRX2] = new InterruptDescription("HINTRX2", "45 HINTRX2 : High-speed serial reception (Hchannel.2)", TxIoListener.REGISTER_IMC0B, 1, NULL_REGISTER, NULL_SECTION);
        hardwareInterruptDescription[HINTTX2] = new InterruptDescription("HINTTX2", "46 HINTTX2 : High-speed serial transmission (Hchannel.2)", TxIoListener.REGISTER_IMC0B, 2, NULL_REGISTER, NULL_SECTION);
        hardwareInterruptDescription[INTSBI0] = new InterruptDescription("INTSBI0", "47 INTSBI0 : Serial bus interface 0 0x0BC", TxIoListener.REGISTER_IMC0B, 3, NULL_REGISTER, NULL_SECTION);
        hardwareInterruptDescription[INTADHPA] = new InterruptDescription("INTADHPA", "48 INTADHPA : Highest priority AD conversion complete interrupt A", TxIoListener.REGISTER_IMC0C, 0, NULL_REGISTER, NULL_SECTION);
        hardwareInterruptDescription[INTADMA] = new InterruptDescription("INTADMA", "49 INTADMA : AD conversion monitoring function interrupt A", TxIoListener.REGISTER_IMC0C, 1, NULL_REGISTER, NULL_SECTION);
        hardwareInterruptDescription[INTADHPB] = new InterruptDescription("INTADHPB", "50 INTADHPB : Highest priority AD conversion complete interrupt B", TxIoListener.REGISTER_IMC0C, 2, NULL_REGISTER, NULL_SECTION);
        hardwareInterruptDescription[INTADMB] = new InterruptDescription("INTADMB", "51 INTADMB : AD conversion monitoring function interrupt B", TxIoListener.REGISTER_IMC0C, 3, NULL_REGISTER, NULL_SECTION);
        hardwareInterruptDescription[INTADHPC] = new InterruptDescription("INTADHPC", "52 INTADHPC : Highest priority AD conversion complete interrupt C", TxIoListener.REGISTER_IMC0D, 0, NULL_REGISTER, NULL_SECTION);
        hardwareInterruptDescription[INTADMC] = new InterruptDescription("INTADMC", "53 INTADMC : AD conversion monitoring function interrupt C", TxIoListener.REGISTER_IMC0D, 1, NULL_REGISTER, NULL_SECTION);
