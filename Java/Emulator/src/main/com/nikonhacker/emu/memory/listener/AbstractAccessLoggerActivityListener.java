...
public abstract class AbstractAccessLoggerActivityListener implements MemoryActivityListener {
    ...
    private Set<DebuggableMemory.AccessSource> selectedAccessSource;

    public AbstractAccessLoggerActivityListener(PrintWriter printWriter, CPUState cpuState, Set<DebuggableMemory.AccessSource> selectedAccessSource) {
        this.printWriter = printWriter;
        this.cpuState = cpuState;
        this.selectedAccessSource = selectedAccessSource;
    }


    public Byte onLoadData8(byte[] pageData, int address, byte value, DebuggableMemory.AccessSource accessSource) {
        if (selectedAccessSource.contains(accessSource)) {
