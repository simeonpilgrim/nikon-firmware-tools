...
// search for 34 FE 00 00, the last instance is the PTP table..
	...
	ptp_func_set(0x912338F8, "10xx");
	ptp_func_set(0x91233FC0, "FXxx");
	ptp_func_set(0x91233B28, "90xx_B");
	ptp_func_set(0x91234848, "90xx");
	ptp_func_set(0x91234C54, "95xx");
	ptp_func_set(0x91234DA4, "92xx");
	
	ptp_prop_set(0x91234E70, "50xx");
	ptp_prop_set(0x912350F4, "D0xx");
