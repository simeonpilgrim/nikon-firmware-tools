diff -rupN --strip-trailing-cr /c/binutils-2.22/bfd/archures.c /src/binutils-2.22/bfd/archures.c
--- /c/binutils-2.22/bfd/archures.c	2011-08-02 01:04:00 +0200
+++ /src/binutils-2.22/bfd/archures.c	2013-10-04 20:20:02 +0200
@@ -340,6 +340,7 @@ DESCRIPTION
...
diff -rupN --strip-trailing-cr /c/binutils-2.22/bfd/bfd-in2.h /src/binutils-2.22/bfd/bfd-in2.h
--- /c/binutils-2.22/bfd/bfd-in2.h	2011-09-16 03:15:00 +0200
+++ /src/binutils-2.22/bfd/bfd-in2.h	2013-10-11 18:42:35 +0200
...
+#define bfd_mach_fr80          0x46523830
 ...
 #define bfd_mach_frv           1
 #define bfd_mach_frvsimple     2
diff -rupN --strip-trailing-cr /c/binutils-2.22/bfd/cpu-fr30.c /src/binutils-2.22/bfd/cpu-fr30.c
--- /c/binutils-2.22/bfd/cpu-fr30.c	2009-09-02 09:18:00 +0200
+++ /src/binutils-2.22/bfd/cpu-fr30.c	2013-10-04 23:19:14 +0200
@@ -22,18 +22,16 @@
 #include "bfd.h"
 #include "libbfd.h"
...
diff -rupN --strip-trailing-cr /c/binutils-2.22/bfd/elf32-fr30.c /src/binutils-2.22/bfd/elf32-fr30.c
--- /c/binutils-2.22/bfd/elf32-fr30.c	2010-10-25 17:54:00 +0200
+++ /src/binutils-2.22/bfd/elf32-fr30.c	2013-10-11 16:37:18 +0200
@@ -634,6 +634,140 @@ fr30_elf_relocate_section (output_bfd, i
   return TRUE;
 }
 
...
@@ -734,6 +868,12 @@ fr30_elf_check_relocs (abfd, info, sec, 
...
diff -rupN --strip-trailing-cr /c/binutils-2.22/cpu/fr30.cpu /src/binutils-2.22/cpu/fr30.cpu
--- /c/binutils-2.22/cpu/fr30.cpu	2011-08-22 17:25:00 +0200
+++ /src/binutils-2.22/cpu/fr30.cpu	2013-10-11 16:28:03 +0200
@@ -31,7 +31,7 @@
...
diff -rupN --strip-trailing-cr /c/binutils-2.22/cpu/fr30.opc /src/binutils-2.22/cpu/fr30.opc
--- /c/binutils-2.22/cpu/fr30.opc	2011-08-22 17:25:00 +0200
+++ /src/binutils-2.22/cpu/fr30.opc	2013-10-11 16:10:10 +0200
@@ -37,14 +37,36 @@
 
 /* -- opc.h */
...
diff -rupN --strip-trailing-cr /c/binutils-2.22/gas/config/tc-fr30.c /src/binutils-2.22/gas/config/tc-fr30.c
--- /c/binutils-2.22/gas/config/tc-fr30.c	2009-07-24 13:45:00 +0200
+++ /src/binutils-2.22/gas/config/tc-fr30.c	2013-10-11 16:44:25 +0200
@@ -26,6 +26,7 @@
...
+}
diff -rupN --strip-trailing-cr /c/binutils-2.22/gas/config/tc-fr30.h /src/binutils-2.22/gas/config/tc-fr30.h
--- /c/binutils-2.22/gas/config/tc-fr30.h	2009-09-02 09:24:00 +0200
+++ /src/binutils-2.22/gas/config/tc-fr30.h	2013-10-09 00:03:30 +0200
...
diff -rupN --strip-trailing-cr /c/binutils-2.22/include/elf/fr30.h /src/binutils-2.22/include/elf/fr30.h
--- /c/binutils-2.22/include/elf/fr30.h	2010-04-15 12:26:00 +0200
+++ /src/binutils-2.22/include/elf/fr30.h	2013-10-06 06:44:13 +0200
...
+
 #endif /* _ELF_FR30_H */
diff -rupN --strip-trailing-cr /c/binutils-2.22/opcodes/fr30-desc.c /src/binutils-2.22/opcodes/fr30-desc.c
--- /c/binutils-2.22/opcodes/fr30-desc.c	2010-02-12 03:25:00 +0100
+++ /src/binutils-2.22/opcodes/fr30-desc.c	2013-10-04 19:38:23 +0200
...
+  },
 ...
 #undef OP
diff -rupN --strip-trailing-cr /c/binutils-2.22/opcodes/fr30-desc.h /src/binutils-2.22/opcodes/fr30-desc.h
--- /c/binutils-2.22/opcodes/fr30-desc.h	2010-10-09 08:50:00 +0200
+++ /src/binutils-2.22/opcodes/fr30-desc.h	2013-10-04 16:48:35 +0200
...
diff -rupN --strip-trailing-cr /c/binutils-2.22/opcodes/fr30-opc.c /src/binutils-2.22/opcodes/fr30-opc.c
--- /c/binutils-2.22/opcodes/fr30-opc.c	2010-02-12 03:25:00 +0100
+++ /src/binutils-2.22/opcodes/fr30-opc.c	2013-10-11 16:38:35 +0200
...
+  },
 ...
 #undef A
diff -rupN --strip-trailing-cr /c/binutils-2.22/opcodes/fr30-opc.h /src/binutils-2.22/opcodes/fr30-opc.h
--- /c/binutils-2.22/opcodes/fr30-opc.h	2010-01-02 18:50:00 +0100
+++ /src/binutils-2.22/opcodes/fr30-opc.h	2013-10-05 23:18:35 +0200
